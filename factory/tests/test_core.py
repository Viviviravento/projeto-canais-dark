...
from factory.core.pipeline import CHANNEL_STAGES, VIDEO_STAGES, FactoryRun, validate_run_payload
...
class ContractTests(unittest.TestCase):
    def test_all_public_schemas_are_valid(self) -> None:
        self.assertGreaterEqual(len(list_contracts()), 13)
...
class PipelineTests(unittest.TestCase):
    ...
    def test_mukbang_dry_run_crosses_same_macro_stages(self) -> None:
        path = Path(__file__).resolve().parents[2] / "research" / "experiments" / "mukbang-ensaio-seco" / "run.json"
