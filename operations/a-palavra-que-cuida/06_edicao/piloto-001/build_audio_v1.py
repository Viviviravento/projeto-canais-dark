...
MANIFEST_PATH = (
    OPERATION_ROOT / "02_roteiros" / "piloto-001-performance-v1.json"
)
ENV_PATH = PROJECT_ROOT / "tools" / "OpenMontage" / ".env"
OUTPUT_DIR = OPERATION_ROOT / "05_audio" / "piloto-001" / "v1"
...
def main() -> int:
    ...
    if args.regenerate_block:
        ...
        revision_record = {
            ...
            "legacy_dir": str(legacy_dir.relative_to(PROJECT_ROOT)),
