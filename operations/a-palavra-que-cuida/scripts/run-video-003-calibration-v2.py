...
MANIFEST = OPERATION_ROOT / "02_roteiros" / "video-003-calibracao-performance-v2.json"
QUOTE_PATH = OPERATION_ROOT / "06_edicao" / "video-003" / "custos" / "elevenlabs-calibracao-v2.json"
EXECUTION_PATH = OPERATION_ROOT / "06_edicao" / "video-003" / "custos" / "elevenlabs-calibracao-v2-execution.json"
OUTPUT_DIR = OPERATION_ROOT / "05_audio" / "video-003" / "calibracao-v2"
GENERATOR = OPERATION_ROOT / "06_edicao" / "piloto-001" / "calibrate_audio.py"
