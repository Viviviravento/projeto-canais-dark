...
AUDIO_DIR = PROJECT_ROOT / "operations" / "a-palavra-que-cuida" / "05_audio" / "video-004" / "v1"
FFMPEG = PROJECT_ROOT / "tools" / "ffmpeg" / "bin" / "ffmpeg.exe"
FFPROBE = PROJECT_ROOT / "tools" / "ffmpeg" / "bin" / "ffprobe.exe"
TEMPO = 1.05
PREFIX = "video-004-narracao-v1"
...
def main() -> None:
    ...
    alignment_path.write_text(
        json.dumps(
            {
                "version": "video-004-master-alignment-1.05x-v1",
                "tempo": TEMPO,
                "pitch": "preserved",
    ...
    audit_path.write_text(
        json.dumps(
            {
                "version": "video-004-audio-postprocess-1.05x-v1",
                "source": source.name,
                "tempo": TEMPO,
                "pitch": "preserved",
