...
from factory.core.contracts import validate_contract  # noqa: E402


def load(relative: str) -> dict:
    return json.loads((OPERATION_ROOT / relative).read_text(encoding="utf-8"))
...
def main() -> None:
    ...
    for source, count in source_counts.items():
        ...
        check((OPERATION_ROOT / source).is_file(), f"asset existe:{source}", failures, passes)
    ...
    thumbnail = OPERATION_ROOT / "08_publicacao/video-003-thumbnail-v1.png"
    ...
    for asset in lineage["assets"]:
        path = OPERATION_ROOT / asset["file"]
    ...
    output = OPERATION_ROOT / "06_edicao/video-003/preproduction-qa-v1.json"
