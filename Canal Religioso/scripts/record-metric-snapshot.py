...
from ai.fabrica.core.metrics import ImmutableRecordStore  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--store", type=Path, default=PROJECT_ROOT / "Canal Religioso" / "09_metricas" / "video-003")
